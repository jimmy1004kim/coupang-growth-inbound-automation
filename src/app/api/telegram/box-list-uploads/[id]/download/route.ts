...
import { getTelegramBoxListUploadFile } from "@/services/telegram-box-list/get-telegram-box-list-upload-file";
...
export async function GET(_request: NextRequest, context: RouteContext) {
  try {
    ...
    const result = await getTelegramBoxListUploadFile(id);
    ...
    logRouteError(error, {
      route: "/api/telegram/box-list-uploads/[id]/download",
      method: "GET",
    });
