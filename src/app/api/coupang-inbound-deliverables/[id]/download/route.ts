...
import { getCoupangInboundDeliverableFile } from "@/services/deliverables/get-coupang-inbound-deliverable-file";
...
export async function GET(_request: NextRequest, context: RouteContext) {
  try {
    ...
    const result = await getCoupangInboundDeliverableFile(id);
    ...
    logRouteError(error, {
      route: "/api/coupang-inbound-deliverables/[id]/download",
      method: "GET",
    });
